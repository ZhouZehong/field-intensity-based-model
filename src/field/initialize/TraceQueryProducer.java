...
/**
 * 真实轨迹Query发生器（暂且采用一次性将所有query初始化的模式）
 * Created by Hong on 2017/9/5.
 */
public class TraceQueryProducer implements Control {
    ...
    public TraceQueryProducer(String prefix){
    ...
    public boolean execute() {
        // 遍历网络中的移动节点，根据节点上的用户兴趣分配情况产生相应的query
        for (int i = 20; i < 97; i++) {
