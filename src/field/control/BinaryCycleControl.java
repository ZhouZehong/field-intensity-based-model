 ...
 */
public class BinaryCycleControl implements Control{
    ...
    public BinaryCycleControl(String prefix){
...
//                            }
                            ...
                            if ((neighborQuery == null)
                                ...
                                minLifeTimeQuery.setRelayCapacity
                                        (minLifeTimeQuery.getRelayCapacity() / 2);
                                cacheQuery.setRelayCapacity
                                        (cacheQuery.getRelayCapacity() / 2);
...
//                            }
                            ...
                            if ((neighborMessage == null)
                                ...
                                maxValueMessage.setRelayCapacity
                                        (maxValueMessage.getRelayCapacity() / 2);
                                cacheMessage.setRelayCapacity
                                        (cacheMessage.getRelayCapacity() / 2);
